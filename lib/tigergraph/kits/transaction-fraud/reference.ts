export const TRANSACTION_FRAUD_REFERENCE = {
...
set exit_on_error = "false"`,
  ...
  loadingJob: `USE GRAPH Transaction_Fraud
...
CREATE LOADING JOB loading_data FOR GRAPH Transaction_Fraud {
      DEFINE FILENAME MyDataSource="$s1:s3://tigergraph-solution-kits/financial_crime/transaction_fraud/data/";
      ...
      LOAD MyDataSource TO VERTEX City VALUES(gsql_concat($6, $7), $6, $11) USING SEPARATOR="|", HEADER="true", EOL="\\n", QUOTE="double";
      ...
      LOAD MyDataSource TO EDGE Located_In VALUES($5 Address, gsql_concat($6, $7) City) USING SEPARATOR="|", HEADER="true", EOL="\\n", QUOTE="double";
      LOAD MyDataSource TO EDGE Located_In VALUES(gsql_concat($6, $7) City, $7 State) USING SEPARATOR="|", HEADER="true", EOL="\\n", QUOTE="double";
      LOAD MyDataSource TO EDGE Assigned_To VALUES($8 Zipcode, gsql_concat($6, $7) City) USING SEPARATOR="|", HEADER="true", EOL="\\n", QUOTE="double";
